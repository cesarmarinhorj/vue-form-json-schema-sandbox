<template>
  <div id="example-six" class="container mb-3 mt-3">
    ...
    <h3>Example #6
      <small class="text-muted">Registration form example</small>
    </h3>
    <p class="lead">
      <span>
        A medium complex example showing a registration form with validation
    ...
    <p class="text-center font-weight-bold">
      <a
        href="https://codesandbox.io/s/4rykx7jj19"
        target="_blank"
    ...
    <p class="text-center font-weight-bold">
      <a
        href="https://4rykx7jj19.codesandbox.io/"
        target="_blank"
        rel="noopener noreferrer"
    ...
    <p>
      <span>
        In this example we configure the options property
        <code>castToSchemaType</code> to allow values to be cast to their
        correct type. Without this property all values would be strings for
        fields where the component is a regular HTML element, such as
        <code>input</code>, which would make any validation based on other types
        fail.
      </span>
    </p>

    <p>
      Try submitting the form empty and see what error messages you get. You can
      try typing a number less than
      <code>18</code> into the
      <strong>Age</strong> input field and moving to another field (i.e. causing
      a
      <code>blur</code> event). This will show you a different validation
      message when the condition
      <code>value &lt; 18</code> is met.
    </p>

    <p>
      Complete the form with valid information and you can see how the message
      below the submit button changes. A different message can be shown when all
      errors have been fixed to let the user know that it can now submit the
      form again and it will succeed.
    </p>

    <p>
      Try filling out the form correctly but enter a value less than
      <code>18</code> into the
      <strong>Age</strong> input field. You see that
      when you navigate away the validation message with the 18 year limit
      appear immediately.
    </p>
